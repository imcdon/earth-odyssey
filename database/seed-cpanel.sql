-- seed-cpanel.sql - Sample data for cPanel/phpMyAdmin import.
-- Import AFTER schema-cpanel.sql, with your cPanel database selected in the left sidebar.
-- Do NOT use seed.sql on cPanel (it runs USE earth_odyssey).
